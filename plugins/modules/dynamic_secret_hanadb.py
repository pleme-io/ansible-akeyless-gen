...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("DynamicSecretCreateHanaDb", dict(module.params, token=token))
    return call_api(module, client, "dynamic_secret_create_hana_db", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("DynamicSecretUpdateHanaDb", dict(module.params, token=token))
    return call_api(module, client, "dynamic_secret_update_hana_db", body)
