...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("RotatedSecretCreateSsh", dict(module.params, token=token))
    return call_api(module, client, "rotated_secret_create_ssh", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("RotatedSecretUpdateSsh", dict(module.params, token=token))
    return call_api(module, client, "rotated_secret_update_ssh", body)
