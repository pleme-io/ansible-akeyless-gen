...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("AuthMethodCreateSAML", dict(module.params, token=token))
    return call_api(module, client, "auth_method_create_saml", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("AuthMethodUpdateSAML", dict(module.params, token=token))
    return call_api(module, client, "auth_method_update_saml", body)
