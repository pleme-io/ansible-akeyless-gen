...
DOCUMENTATION = r'''
---
module: auth_method_saml
short_description: Manages a SAML authentication method
description:
  - Manage auth_method_saml resources.
options:
    state:
...
EXAMPLES = r'''
- name: Create auth_method_saml
  auth_method_saml:
    state: present

- name: Delete auth_method_saml
  auth_method_saml:
    state: absent
'''
...
def create_resource(module):
    ...
    try:
        ...
        module.exit_json(changed=True, msg="auth_method_saml created")
    except Exception as e:
        module.fail_json(msg="Failed to create auth_method_saml: %s" % str(e))
...
def update_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="auth_method_saml updated")
    except Exception as e:
        module.fail_json(msg="Failed to update auth_method_saml: %s" % str(e))
...
def delete_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="auth_method_saml deleted")
    except Exception as e:
        module.fail_json(msg="Failed to delete auth_method_saml: %s" % str(e))
...
def read_resource(module):
    ...
    try:
        ...
        module.fail_json(msg="Failed to read auth_method_saml: %s" % str(e))
...
def main():
    argument_spec = {
        ...
        'idp_metadata_url': {'type': 'str'},
        'idp_metadata_xml_data': {'type': 'str'},
        'jwt_ttl': {'type': 'int'},
    ...
    if state == 'absent':
        if current is not None:
            ...
            module.exit_json(changed=False, msg="auth_method_saml already absent")
    else:
        if current is None:
