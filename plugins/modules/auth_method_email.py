...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("AuthMethodCreateEmail", dict(module.params, token=token))
    return call_api(module, client, "auth_method_create_email", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("AuthMethodUpdateEmail", dict(module.params, token=token))
    return call_api(module, client, "auth_method_update_email", body)
