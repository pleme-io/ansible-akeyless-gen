...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("AuthMethodCreateUniversalIdentity", dict(module.params, token=token))
    return call_api(module, client, "auth_method_create_universal_identity", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("AuthMethodUpdateUniversalIdentity", dict(module.params, token=token))
    return call_api(module, client, "auth_method_update_universal_identity", body)
