...
def create_resource(module):
    ...
    try:
        ...
        module.exit_json(changed=True, msg="target_rabbitmq created")
    except Exception as e:
        module.fail_json(msg="Failed to create target_rabbitmq: %s" % str(e))
...
def update_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="target_rabbitmq updated")
    except Exception as e:
        module.fail_json(msg="Failed to update target_rabbitmq: %s" % str(e))
...
def delete_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="target_rabbitmq deleted")
    except Exception as e:
        module.fail_json(msg="Failed to delete target_rabbitmq: %s" % str(e))
...
def read_resource(module):
    ...
    try:
        ...
        module.fail_json(msg="Failed to read target_rabbitmq: %s" % str(e))
