...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("TargetCreateWeb", dict(module.params, token=token))
    return call_api(module, client, "target_create_web", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("TargetUpdateWeb", dict(module.params, token=token))
    return call_api(module, client, "target_update_web", body)
