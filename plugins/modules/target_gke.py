...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("TargetCreateGke", dict(module.params, token=token))
    return call_api(module, client, "target_create_gke", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("TargetUpdateGke", dict(module.params, token=token))
    return call_api(module, client, "target_update_gke", body)
