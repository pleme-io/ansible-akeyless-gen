...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("TargetCreateDockerhub", dict(module.params, token=token))
    return call_api(module, client, "target_create_dockerhub", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("TargetUpdateDockerhub", dict(module.params, token=token))
    return call_api(module, client, "target_update_dockerhub", body)
