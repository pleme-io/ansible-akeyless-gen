...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("DynamicSecretCreateCassandra", dict(module.params, token=token))
    return call_api(module, client, "dynamic_secret_create_cassandra", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("DynamicSecretUpdateCassandra", dict(module.params, token=token))
    return call_api(module, client, "dynamic_secret_update_cassandra", body)
