...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("TargetCreateSsh", dict(module.params, token=token))
    return call_api(module, client, "target_create_ssh", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("TargetUpdateSsh", dict(module.params, token=token))
    return call_api(module, client, "target_update_ssh", body)
