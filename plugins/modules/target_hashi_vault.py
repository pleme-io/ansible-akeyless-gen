...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("TargetCreateHashiVault", dict(module.params, token=token))
    return call_api(module, client, "target_create_hashi_vault", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("TargetUpdateHashiVault", dict(module.params, token=token))
    return call_api(module, client, "target_update_hashi_vault", body)
