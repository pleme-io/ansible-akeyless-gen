...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("RotatedSecretCreateSnowflake", dict(module.params, token=token))
    return call_api(module, client, "rotated_secret_create_snowflake", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("RotatedSecretUpdateSnowflake", dict(module.params, token=token))
    return call_api(module, client, "rotated_secret_update_snowflake", body)
