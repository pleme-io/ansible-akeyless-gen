...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("TargetCreateOpenAI", dict(module.params, token=token))
    return call_api(module, client, "target_create_open_ai", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("TargetUpdateOpenAI", dict(module.params, token=token))
    return call_api(module, client, "target_update_open_ai", body)
