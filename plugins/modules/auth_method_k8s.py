...
EXAMPLES = r'''
- name: Create auth_method_k8s
  auth_method_k8s:
    state: present

- name: Delete auth_method_k8s
  auth_method_k8s:
    state: absent
'''
...
def create_resource(module):
    ...
    try:
        ...
        module.exit_json(changed=True, msg="auth_method_k8s created")
    except Exception as e:
        module.fail_json(msg="Failed to create auth_method_k8s: %s" % str(e))
...
def update_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="auth_method_k8s updated")
    except Exception as e:
        module.fail_json(msg="Failed to update auth_method_k8s: %s" % str(e))
...
def delete_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="auth_method_k8s deleted")
    except Exception as e:
        module.fail_json(msg="Failed to delete auth_method_k8s: %s" % str(e))
...
def read_resource(module):
    ...
    try:
        ...
        module.fail_json(msg="Failed to read auth_method_k8s: %s" % str(e))
...
def main():
    argument_spec = {
        ...
        'bound_namespaces': {'type': 'list', 'elements': 'str'},
        'bound_pod_names': {'type': 'list', 'elements': 'str'},
        'bound_sa_names': {'type': 'list', 'elements': 'str'},
    ...
    if state == 'absent':
        if current is not None:
            ...
            module.exit_json(changed=False, msg="auth_method_k8s already absent")
    else:
        if current is None:
