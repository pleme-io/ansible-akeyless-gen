...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("AuthMethodCreateK8s", dict(module.params, token=token))
    return call_api(module, client, "auth_method_create_k8s", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("AuthMethodUpdateK8s", dict(module.params, token=token))
    return call_api(module, client, "auth_method_update_k8s", body)
