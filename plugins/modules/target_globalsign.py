...
def create_resource(module):
    ...
    try:
        ...
        module.exit_json(changed=True, msg="target_globalsign created")
    except Exception as e:
        module.fail_json(msg="Failed to create target_globalsign: %s" % str(e))
...
def update_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="target_globalsign updated")
    except Exception as e:
        module.fail_json(msg="Failed to update target_globalsign: %s" % str(e))
...
def delete_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="target_globalsign deleted")
    except Exception as e:
        module.fail_json(msg="Failed to delete target_globalsign: %s" % str(e))
...
def read_resource(module):
    ...
    try:
        ...
        module.fail_json(msg="Failed to read target_globalsign: %s" % str(e))
...
def main():
    ...
    if state == 'absent':
        if current is not None:
            ...
            module.exit_json(changed=False, msg="target_globalsign already absent")
    else:
        if current is None:
