...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("AuthMethodCreateApiKey", dict(module.params, token=token))
    return call_api(module, client, "auth_method_create_api_key", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("AuthMethodUpdateApiKey", dict(module.params, token=token))
    return call_api(module, client, "auth_method_update_api_key", body)
