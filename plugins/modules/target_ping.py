...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("TargetCreatePing", dict(module.params, token=token))
    return call_api(module, client, "target_create_ping", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("TargetUpdatePing", dict(module.params, token=token))
    return call_api(module, client, "target_update_ping", body)
