...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("RotatedSecretCreateLdap", dict(module.params, token=token))
    return call_api(module, client, "rotated_secret_create_ldap", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("RotatedSecretUpdateLdap", dict(module.params, token=token))
    return call_api(module, client, "rotated_secret_update_ldap", body)
