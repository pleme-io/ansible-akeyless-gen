...
DOCUMENTATION = r'''
---
module: rotated_secret_ldap
short_description: Manages an LDAP rotated secret
description:
  - Manage rotated_secret_ldap resources.
options:
    state:
...
- name: Delete rotated_secret_ldap
  rotated_secret_ldap:
    state: absent
'''
...
def create_resource(module):
    ...
    try:
        ...
        module.exit_json(changed=True, msg="rotated_secret_ldap created")
    except Exception as e:
        module.fail_json(msg="Failed to create rotated_secret_ldap: %s" % str(e))
...
def update_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="rotated_secret_ldap updated")
    except Exception as e:
        module.fail_json(msg="Failed to update rotated_secret_ldap: %s" % str(e))
...
def delete_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="rotated_secret_ldap deleted")
    except Exception as e:
        module.fail_json(msg="Failed to delete rotated_secret_ldap: %s" % str(e))
...
def read_resource(module):
    ...
    try:
        ...
        module.fail_json(msg="Failed to read rotated_secret_ldap: %s" % str(e))
...
def main():
    ...
    if state == 'absent':
        if current is not None:
            ...
            module.exit_json(changed=False, msg="rotated_secret_ldap already absent")
    else:
        if current is None:
