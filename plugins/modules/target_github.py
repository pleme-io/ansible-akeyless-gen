...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("TargetCreateGithub", dict(module.params, token=token))
    return call_api(module, client, "target_create_github", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("TargetUpdateGithub", dict(module.params, token=token))
    return call_api(module, client, "target_update_github", body)
