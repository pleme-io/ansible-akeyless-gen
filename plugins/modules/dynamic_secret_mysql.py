...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("DynamicSecretCreateMySql", dict(module.params, token=token))
    return call_api(module, client, "dynamic_secret_create_my_sql", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("DynamicSecretUpdateMySql", dict(module.params, token=token))
    return call_api(module, client, "dynamic_secret_update_my_sql", body)
