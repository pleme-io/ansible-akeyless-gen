...
def create_resource(module):
    ...
    try:
        ...
        module.exit_json(changed=True, msg="auth_method_oauth2 created")
    except Exception as e:
        module.fail_json(msg="Failed to create auth_method_oauth2: %s" % str(e))
...
def update_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="auth_method_oauth2 updated")
    except Exception as e:
        module.fail_json(msg="Failed to update auth_method_oauth2: %s" % str(e))
...
def delete_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="auth_method_oauth2 deleted")
    except Exception as e:
        module.fail_json(msg="Failed to delete auth_method_oauth2: %s" % str(e))
...
def read_resource(module):
    ...
    try:
        ...
        module.fail_json(msg="Failed to read auth_method_oauth2: %s" % str(e))
