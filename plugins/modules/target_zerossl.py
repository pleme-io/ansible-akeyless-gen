...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("TargetCreateZeroSSL", dict(module.params, token=token))
    return call_api(module, client, "target_create_zero_ssl", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("TargetUpdateZeroSSL", dict(module.params, token=token))
    return call_api(module, client, "target_update_zero_ssl", body)
