...
def create_resource(module):
    ...
    try:
        ...
        module.exit_json(changed=True, msg="event_forwarder_slack created")
    except Exception as e:
        module.fail_json(msg="Failed to create event_forwarder_slack: %s" % str(e))
...
def update_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="event_forwarder_slack updated")
    except Exception as e:
        module.fail_json(msg="Failed to update event_forwarder_slack: %s" % str(e))
...
def delete_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="event_forwarder_slack deleted")
    except Exception as e:
        module.fail_json(msg="Failed to delete event_forwarder_slack: %s" % str(e))
...
def read_resource(module):
    ...
    try:
        ...
        module.fail_json(msg="Failed to read event_forwarder_slack: %s" % str(e))
...
def main():
    ...
    if state == 'absent':
        if current is not None:
            ...
            module.exit_json(changed=False, msg="event_forwarder_slack already absent")
    else:
        if current is None:
