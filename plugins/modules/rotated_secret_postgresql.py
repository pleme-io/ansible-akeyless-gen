...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("RotatedSecretCreatePostgresql", dict(module.params, token=token))
    return call_api(module, client, "rotated_secret_create_postgresql", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("RotatedSecretUpdatePostgresql", dict(module.params, token=token))
    return call_api(module, client, "rotated_secret_update_postgresql", body)
