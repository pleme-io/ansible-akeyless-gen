...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("TargetCreateGitlab", dict(module.params, token=token))
    return call_api(module, client, "target_create_gitlab", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("TargetUpdateGitlab", dict(module.params, token=token))
    return call_api(module, client, "target_update_gitlab", body)
