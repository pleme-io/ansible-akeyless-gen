...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("DynamicSecretCreateRedshift", dict(module.params, token=token))
    return call_api(module, client, "dynamic_secret_create_redshift", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("DynamicSecretUpdateRedshift", dict(module.params, token=token))
    return call_api(module, client, "dynamic_secret_update_redshift", body)
