...
def create_resource(module):
    ...
    try:
        ...
        module.exit_json(changed=True, msg="target_godaddy created")
    except Exception as e:
        module.fail_json(msg="Failed to create target_godaddy: %s" % str(e))
...
def update_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="target_godaddy updated")
    except Exception as e:
        module.fail_json(msg="Failed to update target_godaddy: %s" % str(e))
...
def delete_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="target_godaddy deleted")
    except Exception as e:
        module.fail_json(msg="Failed to delete target_godaddy: %s" % str(e))
...
def read_resource(module):
    ...
    try:
        ...
        module.fail_json(msg="Failed to read target_godaddy: %s" % str(e))
