...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("TargetCreateSectigo", dict(module.params, token=token))
    return call_api(module, client, "target_create_sectigo", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("TargetUpdateSectigo", dict(module.params, token=token))
    return call_api(module, client, "target_update_sectigo", body)
