...
def create_resource(module):
    ...
    try:
        ...
        module.exit_json(changed=True, msg="rotated_secret_aws created")
    except Exception as e:
        module.fail_json(msg="Failed to create rotated_secret_aws: %s" % str(e))
...
def update_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="rotated_secret_aws updated")
    except Exception as e:
        module.fail_json(msg="Failed to update rotated_secret_aws: %s" % str(e))
...
def delete_resource(module):
    ...
    try:
        # TODO: implement API call
        module.exit_json(changed=True, msg="rotated_secret_aws deleted")
    except Exception as e:
        module.fail_json(msg="Failed to delete rotated_secret_aws: %s" % str(e))
...
def read_resource(module):
    ...
    try:
        ...
        module.fail_json(msg="Failed to read rotated_secret_aws: %s" % str(e))
