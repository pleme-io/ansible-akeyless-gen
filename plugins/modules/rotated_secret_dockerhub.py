...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("RotatedSecretCreateDockerhub", dict(module.params, token=token))
    return call_api(module, client, "rotated_secret_create_dockerhub", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("RotatedSecretUpdateDockerhub", dict(module.params, token=token))
    return call_api(module, client, "rotated_secret_update_dockerhub", body)
