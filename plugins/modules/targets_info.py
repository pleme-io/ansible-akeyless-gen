...
---
module: targets_info
short_description: List all targets
description:
  - Retrieve information about targets_info.
options:

'''

EXAMPLES = r'''
- name: Get targets_info
  targets_info:
    register: result
'''
...
def read_resource(module, client, token):
    ...
    body = build_body("ListTargets", dict(module.params, token=token))
    return call_api(module, client, "list_targets", body)
