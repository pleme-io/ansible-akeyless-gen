...
def create_resource(module, client, token):
    """Create the resource."""
    body = build_body("DynamicSecretCreateArtifactory", dict(module.params, token=token))
    return call_api(module, client, "dynamic_secret_create_artifactory", body)
...
def update_resource(module, client, token):
    ...
    body = build_body("DynamicSecretUpdateArtifactory", dict(module.params, token=token))
    return call_api(module, client, "dynamic_secret_update_artifactory", body)
